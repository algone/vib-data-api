...
//            window.prompt(this.options.promptText, latCoordinate + ' ' + lngCoordinate);
    ...
    setCoordinates: function (obj)
    {
        ...
        if (obj.latlng) {
            ...
            document.getElementById('lat').value = obj.latlng.lat.toFixed(this.options.precision).toString();
            document.getElementById('lon').value = obj.latlng.lng.toFixed(this.options.precision).toString();
